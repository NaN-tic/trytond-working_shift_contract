...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        shift5_intervention0, shift5_intervention1 = sorted(
            shift5.interventions, key=lambda x: x.id)
        self.assertEqual(
        ...
        self.assertEqual(shift4_intervention.customer_invoice_line,
                         shift5_intervention1.customer_invoice_line)
        self.assertEqual(
            shift5_intervention0.customer_invoice_line.invoice.party, customer1)
        self.assertEqual(shift5_intervention0.customer_invoice_line.product,
                         service_intervention)
        self.assertEqual(shift5_intervention0.customer_invoice_line.quantity,
                         1.0)
        self.assertEqual(shift5_intervention0.customer_invoice_line.amount,
                         Decimal('300.00'))
